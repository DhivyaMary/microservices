...
@Validated
@Tag(name = "CRUD REST APIs for Accounts in XYZBank",
        description = "CRUD REST APIs in XYZBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
...
public class AccountsController {
    ...
    @Operation(summary = "Create Account REST API",
            description = "REST API to create new Customer &  Account inside XYZBank")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity fetchAccountDetails(@RequestParam
        ...
        CustomerDto customerDto = accountService.fecthAccountDetails(mobileNumber);
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(customerDto);
    }
    ...
    @Operation(
            ...
            description = "Get Build Version of "
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
